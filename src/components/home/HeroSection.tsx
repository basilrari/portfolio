    ...
    <section id="home" className="mb-12 md:mb-16">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12">
        ...
        <div>
          ...
          <p className="mt-1 text-xs font-medium tracking-[0.2em]" style={{ color: 'var(--text-muted)' }}>
            {site.title}
          </p>

          <p className="mt-5 max-w-md text-sm leading-relaxed md:text-[15px]" style={{ color: 'var(--text-secondary)' }}>
            {site.bio}
          </p>
        ...
        <div>
          ...
          <h2 className="text-2xl font-bold leading-tight tracking-tight md:text-3xl lg:text-[2rem]" style={{ color: 'var(--text-primary)' }}>
            {site.headline}
          </h2>

          <p className="mt-4 max-w-lg text-sm leading-relaxed md:text-[15px]" style={{ color: 'var(--text-secondary)' }}>
            {site.subheadline}
          </p>

          <div
            className="my-8 flex h-48 items-center justify-center overflow-hidden rounded-lg md:h-56"
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              Download Resume
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 20.25h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12M12 16.5V3" />
              </svg>
            </a>
          </div>
        </div>
