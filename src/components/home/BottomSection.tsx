...
export default function BottomSection() {
  return (
    <ScrollReveal>
      <section
        className="grid grid-cols-1 gap-8 border-t pt-10 md:grid-cols-2 md:gap-12"
      ...
      >
        ...
        <div>
          ...
          <div className="mt-8 space-y-2">
            ...
            <a
              ...
              className="micro-cta block text-sm theme-transition"
        ...
        <div>
          <h3
            className="mb-5 flex items-center gap-2 text-[10px] font-semibold tracking-[0.2em]"
            style={{ color: 'var(--text-muted)' }}
          >
