    ...
    <svg viewBox="0 0 400 280" fill="none" className="h-full w-full" aria-hidden="true">
      ...
      {[
        ...
        <g key={i}>
          ...
          <ellipse cx={cx} cy={cy} rx="22" ry="4" stroke="var(--text-primary)" strokeWidth="1" opacity="0.35" transform={`rotate(${i * 45} ${cx} ${cy})`} />
        </g>
      ))}
      {/* Body */}
...
export function LLMVisual() {
  return (
    <svg viewBox="0 0 280 160" fill="none" className="h-full w-full" aria-hidden="true">
      ...
      <rect x="170" y="110" width="70" height="22" rx="4" stroke="var(--wireframe-stroke)" strokeWidth="0.75" fill="var(--wireframe-fill)" />
