  ...
  return (
    <section id="contact" className="py-20 px-6 bg-slate-900/30">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <p className="font-mono text-emerald-400 text-sm tracking-wider mb-3">04 / Contact</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Let's Build Something
          </h2>
          <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
            Open to research collaborations, engineering roles, and conversations about
            autonomous systems, AI, and drones.
          </p>
